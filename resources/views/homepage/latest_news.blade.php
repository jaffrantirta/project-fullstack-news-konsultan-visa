               ...
               <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="about-right mb-90">
                            <div class="about-img">
                                <img src="res/assets/img/trending/trending_top.jpg" alt="">
                            </div>
                            ...
                            <div class="social-share pt-30">
                                <div class="section-tittle">
                                    ...
                                    <ul>
                                        <li><a href="#"><img src="res/assets/img/news/icon-ins.png" alt=""></a></li>
                                        <li><a href="#"><img src="res/assets/img/news/icon-fb.png" alt=""></a></li>
                                        <li><a href="#"><img src="res/assets/img/news/icon-tw.png" alt=""></a></li>
                                        <li><a href="#"><img src="res/assets/img/news/icon-yo.png" alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="news-poster d-none d-lg-block">
                            <img src="res/assets/img/news/news_card.jpg" alt="">
                        </div>
                    </div>
               </div>
        </div>
