          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Buat Berita Baru</h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-9 col-md-12">
                ...
                <div class="card card-small mb-3">
                  <div class="card-body">
                    <form id="news_form" class="add-new-post" method="POST" enctype="multipart/form-data" action="{{URL::to('/post/add')}}">
                      @csrf
                      <input id="title" name="title" class="form-control form-control-lg mb-3" type="text" placeholder="Judul Berita">
                      <input id="author" name="author" class="form-control form-control-lg mb-3" type="text" placeholder="Pengarang (jika dikosongkan akan terisi nama yang login saat ini)">
                      <input id="picture" name="file" class="form-control form-control-lg mb-3" type="file">
                      <input name="is_published" type="hidden" value="1">
                      <textarea name="content" id="content" placeholder="Konten" class="ckeditor" id="ckedtor"></textarea>
                  ...
                  <div class='card-body p-0'>
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item d-flex px-3">
                        <div class="row p-2">
                          <a href="#" onclick="save_local()" class="mt-1 col-12 btn btn-sm btn-outline-accent">
                            <i class="material-icons">save</i> Simpan Sesi</a>
                          <a href="#" onclick="delete_local()" class="mt-1 col-12 btn btn-sm btn-outline-danger">
                            <i class="fa fa-trash"></i> Hapus Sesi</a>
                          <a href="#" onclick="save()" class="mt-1 col-12 btn btn-sm btn-accent ml-auto">
                            <i class="fa fa-upload"></i> Publikasi</a>
                        </div>
                      </li>
                    </ul>
                  </div>
