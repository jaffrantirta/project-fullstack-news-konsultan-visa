          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <!-- End Page Header -->
             <div class="row">
                        ...
                        <tbody>
                            @foreach($categories as $data)
                                <tr>
                                    ...
                                    <td><a onclick="getData({{$data->id}}, '{{$data->category}}')" href="#edit-category" data-toggle="modal">Edit</a> | <a onclick="setID({{$data->id}})" style="color: red" href="#del-category" data-toggle="modal">Hapus</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                      </table>
              ...
              <div class="row">
                <div class="col-12">
                  <button data-toggle="modal" data-target="#add-category" class="btn-lg btn-primary">Tambah Kategori</button>
                </div>
              </div>
          </div>
